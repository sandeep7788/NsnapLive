...
import chatroom.snap.snaplive.Mapbox;
import chatroom.snap.snaplive.R;
import chatroom.snap.snaplive.custom.MessageSelectD;
import chatroom.snap.snaplive.custom.ReactCustom;
import chatroom.snap.snaplive.global.Global;

import chatroom.snap.snaplive.mediachat.VideoA;
...
//view init
        ...
        if (message.getType().equals("voice")) {
            ...
            MapboxStaticMap staticImage = MapboxStaticMap.builder()
                    .accessToken(Global.conA.getResources().getString(R.string.mapbox_access_token))
                    .styleId(StaticMapCriteria.LIGHT_STYLE)
                    .cameraPoint(Point.fromLngLat(Double.parseDouble(lat), Double.parseDouble(lng))) // Image's centerpoint on map
                    .cameraZoom(10)
                    .width(187) // Image width
            ...
            map.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (location.length == 2) {
                        lat = location[0];
                        lng = location[1];
                        Intent intent = new Intent(Global.conA, Mapbox.class);
