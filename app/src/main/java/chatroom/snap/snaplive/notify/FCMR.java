...
import chatroom.snap.snaplive.calls.IncAudioActivity;
import chatroom.snap.snaplive.calls.IncCallActivity;
...
import chatroom.snap.snaplive.lists.OnlineGetter;
import chatroom.snap.snaplive.lists.Usercalldata;
...
//inside notification
    ...
    void GetMessage(Map<String, String> map) {
        ...
        if (react != null) {
            ...
            if (message.contains("react//like//"))
                prefixR = getResources().getString(chatroom.snap.snaplive.R.string.likeR);
            else if (message.contains("react//funny//"))
                prefixR = getResources().getString(chatroom.snap.snaplive.R.string.funnyR);
            else if (message.contains("react//love//"))
                prefixR = getResources().getString(chatroom.snap.snaplive.R.string.loveR);
            else if (message.contains("react//sad//"))
                prefixR = getResources().getString(chatroom.snap.snaplive.R.string.sadR);
            else if (message.contains("react//angry//"))
                prefixR = getResources().getString(chatroom.snap.snaplive.R.string.angryR);
    ...
    void Call(Map<String, String> map) {
        ...
        Log.e("channelId", "Call: "+channelId);
                ...
                if (!Global.mutelist.contains(senderId)) {
                    ...
                    mcall.child(mAuth.getCurrentUser().getUid()).child(callerId).child(channelId).addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            ...
                            Intent jumptocall1 = new Intent(conn, IncCallActivity.class);
                            Log.e("@@",channelId);
                            jumptocall1.putExtra("channel_id", channelId);
                                ...
                                if (usercalldata.isIncall()) {
                                    ...
                                    if (Global.IncAActivity == null && Global.IncVActivity == null) {
                                        if (type.equals("videoCall")) {
                                            ...
                                            jumptocall.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                                            startActivity(jumptocall);
                                            Log.e(TAG, "onDataChange: "+"video"+channelId);
                                        }
                                    } else {
                                        Map<String, Object> map = new HashMap<>();
