package chatroom.snap.snaplive.calls;
...
import chatroom.snap.snaplive.Notification.CallNotification;
                    ...
                    FirebaseDatabase.getInstance().getReference(Global.USERS).child(friendid).child(Global.device).addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            if (dataSnapshot.exists()){
                                ...
                                CallNotification callNotification = new CallNotification(Global.nameLocal,Global.avaLocal,friendid
                                        ,encryption.encryptOrNull(channelid),encryption.encryptOrNull(mAuth.getCurrentUser().getUid())
                                        ,encryption.encryptOrNull(Global.nameLocal),encryption.encryptOrNull(Global.avaLocal)
            ...
            mTokenget.child(id).addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    if (mAuth.getCurrentUser() != null) {
                        ...
                        Message  messageMM = new Message(Global.nameLocal,Global.avaLocal,id,message,null,mAuth.getCurrentUser().getUid(),Mid);
