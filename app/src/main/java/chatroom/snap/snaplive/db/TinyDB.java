...
package chatroom.snap.snaplive.db;
...
public class TinyDB {
    ...
    public ArrayList<MessageIn> getListChats(String key){
    	Gson gson = new Gson();
    ...
    public ArrayList<UserIn> getListDialog(String key){
        ...
        ArrayList<String> objStrings = getListString(key);
        ArrayList<UserIn> objects =  new ArrayList<UserIn>();

        for(String jObjString : objStrings){
            UserIn value  = gson.fromJson(jObjString,  UserIn.class);
            objects.add(value);
        }
        return objects;
    }
    ...
    public void putListChats(String key, ArrayList<MessageIn> objArray){
    	checkForNullKey(key);
    	Gson gson = new Gson();
